...
const ClassCard = ({ item }) => {
    const { image, course_name, available_seats, instructors, course_price, enrolled_student } = item;
    return (
        <div className="card lg:card-side bg-green-200 w-full mx-auto mt-8">
